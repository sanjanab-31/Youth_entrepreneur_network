        ...
        <div className="space-y-10 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    ...
                    <p className="text-gray-500 mt-2 font-medium">Real-time execution updates and ecosystem alerts.</p>
                </div>
                <div className="flex gap-3">
                    <button className="flex items-center gap-2 px-5 py-2 bg-white/5 border border-white/10 rounded-xl text-gray-400 font-bold hover:text-white transition-all text-xs uppercase tracking-widest"><Filter size={14} /> Filter</button>
                    <button className="flex items-center gap-2 px-5 py-2 bg-[#8B5CF6]/10 border border-[#8B5CF6]/20 rounded-xl text-[#8B5CF6] font-bold text-xs uppercase tracking-widest">Mark All Read</button>
                </div>
            </div>
                            ...
                            <div className="flex gap-6 relative z-10">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start mb-2">
                                        ...
                                        <button className="p-2 text-gray-700 hover:text-white transition-colors opacity-0 group-hover:opacity-100"><MoreHorizontal size={20} /></button>
                                    </div>
