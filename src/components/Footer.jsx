...
const Footer = () => {
    return (
        <footer className="bg-sky-950 text-sky-100/60 py-20 border-t border-sky-900/50">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    {/* Brand Section */}
                    <div className="md:col-span-1 space-y-6">
                        <div className="flex items-center space-x-3">
                            <div className="w-10 h-10 overflow-hidden rounded-xl border border-sky-800/50 shadow-lg shadow-sky-900/40">
                    ...
                    <div className="md:col-span-2 grid grid-cols-2 sm:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <nav className="flex flex-col space-y-3 text-sm">
                                ...
                                <a href="/careers" className="hover:text-sky-400 transition-colors">Careers</a>
                        ...
                        <div className="space-y-4">
                            ...
                            <nav className="flex flex-col space-y-3 text-sm">
                                <a href="/help" className="hover:text-sky-400 transition-colors">Help Center</a>
                                <a href="/privacy" className="hover:text-sky-400 transition-colors">Privacy</a>
                                <a href="/terms" className="hover:text-sky-400 transition-colors">Terms</a>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-1 space-y-6">
                        ...
                        <div className="flex items-center space-x-4">
                            {[Twitter, Youtube, Instagram, MessageCircle].map((Icon, i) => (
                                <a key={i} href="#" className="w-10 h-10 rounded-xl bg-sky-900 flex items-center justify-center hover:bg-sky-600 hover:text-white transition-all transform hover:-translate-y-1">
                                    <Icon className="w-5 h-5" />
                                </a>
                            ))}
                        </div>
                        <div className="pt-4">
                            <p className="text-xs font-bold text-sky-500 uppercase tracking-widest mb-1">Contact Support</p>
                            <p className="text-sm text-white font-medium italic-not">hello@yennetwork.com</p>
                        </div>
                    </div>
                </div>

                <div className="pt-8 border-t border-sky-900/50 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs font-bold uppercase tracking-[0.2em] text-sky-100/30">
